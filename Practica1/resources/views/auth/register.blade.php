...
@section('contenido')
    <div class="md:flex md:justify-center md:gap-10 md:items-center">
        ...
        <div class="md:w-5/12 p-5">
            {{-- insertar imagen utilizando "asset" para acceder a carpeta pública --}}
            <img src="{{ asset('imagenes/registrar.jpg') }}" alt="registro de usuarios" style="border-radius: 15px; border: 3px solid #617a7a;">
        </div>
          
        {{-- Columna para mostrar el formulario --}}
        <div class="md:w-5/12 bg:white p-5 rounded-lg shadow-xl">
            {{-- Seccion del formulario para los diferentes elementos solicitados a ser llenado como nombre, username, password y correo --}}
            <form>
                
                <div class="mb-5">
                    <label for="name" class="mb-2 block uppercase text-cyan-700 font-bold">
                        Nombre
                    </label>
                ...
                <div class="mb-5">
                    <label for="username" class="mb-2 block uppercase text-cyan-700 font-bold">
                        Username
                    </label>
                ...
                <div class="mb-5">
                    <label for="email" class="mb-2 block uppercase text-cyan-700 font-bold">
                        Email
                    </label>
                ...
                <div class="mb-5">
                    <label for="password" class="mb-2 block uppercase text-cyan-700 font-bold">
                        Password
                    </label>
                ...
                <div class="mb-5">
                    <label for="password_confirmation" class="mb-2 block uppercase text-cyan-700 font-bold">
                        Password
                    </label>
                ...
                <input type="submit" value="crear cuenta" class="bg-gray-800 hover:bg-gray-800 transition-colors cursor-pointer uppercase font-bold w-full p-3 text-white rounded-lg">
            </form>
        </div>  
    </div>
