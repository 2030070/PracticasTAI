...
@section('contenido')
    ...
    <section id="about" class="section transform hover:scale-105 transition-transform duration-500" >
        <div class="title" id="sobreMi">
            ...
            <div class="flex justify-center ">
                <img src="./imagenes/YO.jpg" class="img-hover" width="200" height="200" style="border-radius: 15%; margin-top: 12px; margin-bottom: 12px;" >
            </div>
    ...
    <section id="curriculum" class="section transform hover:scale-105 transition-transform duration-500" >
        <div class="title" id="curriculum">
            ...
            <div class="flex justify-center ">
                <img src="./imagenes/CV_CESAR.png" width="1000" height="1900" class="img-hover">
            </div>
        </div>
    </section>
    <br><br>
            ...
            <div class="carousel relative">
                ...
                <div class="carousel-inner">
                  ...
                  <div class="carousel-item">
                    <img src="./imagenes/futbol.jpg" width="200" height="200" alt="Imagen 1">
                  </div>
                  <div class="carousel-item">
                    <img src="./imagenes/tirolesa1.jpg" width="200" height="200" alt="Imagen 2">
                  </div>
                  <div class="carousel-item">
                    <img src="./imagenes/tirolesa2.jpg" width="200" height="200" alt="Imagen 1">
                  </div>
                  <div class="carousel-item">
                    <img src="./imagenes/grupo.jpg" width="200" height="200" alt="Imagen 2">
                  </div>

                  <!-- Videos -->
                  <div class="carousel-item">
                    <video controls>
                      <source src="./imagenes/Battlefield.mp4" width="200" height="200" type="video/mp4">
                    </video>
                  </div>
                  <div class="carousel-item">
                    <video controls>
                      <source src="/imagenes/EstructuraSimple.mp4" width="200" height="200" type="video/mp4">
                    </video>
                  </div>
                </div>
    ...
    <section id="contact" class="section" >
        <div class="title transform hover:scale-105 transition-transform duration-500">
            ...
            <div class="flex justify-center ">
                <img src="./imagenes/of3.png" class="img-hover" width="600" height="600" style="border-radius: 10%; margin-top: 12px; margin-bottom: 12px;" >
            </div>
